        ...
        <section className="py-24 overflow-x-clip">
            <div className="container relative">
                ...
                <div className="absolute left-56 top-96 hidden lg:block">
                    <Pointer name="Test1" color="blue" />
                </div>
                <div className="absolute right-80 -top-4 hidden lg:block">
                    <Pointer name="Test2" color="red" />
                </div>
                ...
                <p className="text-center text-lg sm:text-xl text-white/50 mt-8 max-w-2xl mx-auto px-4">
                    Join a vibrant community of developers. Share knowledge,
                    build projects, and accelerate your growth.
                </p>
                <div className="px-4 sm:px-0">
                    <form className="flex flex-col sm:flex-row gap-2 sm:gap-0 border border-white/15 rounded-full p-2 mt-8 max-w-md mx-auto">
                        <input
                            type="email"
